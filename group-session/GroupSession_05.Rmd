...
<img src="http://urbanbigdata.github.io/05-lecture-spatial_data/group-session/images/bounding_box.png" height="700px">

For latitude, click `+` and select `Filter`. Choose column `Latitude` and the opeator `between` to data between 47.484 and 47.767.
For longitude, click `+` and select `Filter`. Choose column `Latitude` and the opeator `between` to data between -122.446 and -122.183.
